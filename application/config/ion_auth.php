 ...
 */
$config['site_title']                 = "smartfarmer.com";       // Site Title, example.com
...
$config['lockout_time']               = FALSE;                 /* The number of seconds to lockout an account due to exceeded attempts
